...
BEGIN TRY
    ...
    -- Clear existing data (in reverse dependency order to avoid FK constraint issues)
    ...
    ('A1111111-1111-1111-1111-111111111109', '00000000-0000-0000-0000-000000000015', 'FPT', 'SE170020', 'FPT University');
    ...
    ('B1111111-1111-1111-1111-111111111103','C0000000-0000-0000-0000-000000000010','00000000-0000-0000-0000-000000000010','Pending');

    -- =========================================================
    -- 3. TEAMS AND MEMBERS
    -- =========================================================
    -- Standard HealthStatus default is 'Green'. Specifying explicitly here.
    ...
    ('A1111111-1111-1111-1111-111111111109','E0000000-0000-0000-0000-000000000001','00000000-0000-0000-0000-000000000015','2026-02-18','Registered');
    ...
    ('AAA00001-0001-0001-0001-000000000001','00000000-0000-0000-0000-000000000001','TEAM_CREATE', NULL, '{"TeamName":"Phoenix AI"}', '2026-02-15 09:00:00'),
    ...
    -- =========================================================
    -- 7. MATCHMAKING, MENTORSHIP AND USER SKILLS (New Tables)
    -- =========================================================
    ...
    ('E1111111-1111-1111-1111-111111111104', '00000000-0000-0000-0000-000000000008', 'AI Engineer', 'Python / PyTorch', 'Beginner', GETDATE()),
    ('E1111111-1111-1111-1111-111111111105', '00000000-0000-0000-0000-000000000015', 'Fullstack Developer', 'Node.js & React', 'Intermediate', GETDATE());
    ...
    ('50000000-0000-0000-0000-000000000002', '70000000-0000-0000-0000-000000000002', 'React Developer', N'We need a frontend developer specialized in TailwindCSS and state management.', 2, 'OPEN', GETDATE(), NULL);

    INSERT INTO TeamApplications (ApplicationId, RecruitmentId, TeamId, UserId, Message, Status, CreatedAt, UpdatedAt) VALUES
    ('60000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000002', '70000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000015', N'I have strong React skills and would love to join your team!', 'PENDING', GETDATE(), NULL);
    ...
    ('80000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000010', '2026-03-11 14:00:00', '2026-03-11 15:00:00', N'Google Meet', 1),
    ('80000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000010', '2026-03-11 15:30:00', '2026-03-11 16:30:00', N'Google Meet', 0);
    ...
    ('90000000-0000-0000-0000-000000000002', '80000000-0000-0000-0000-000000000003', '70000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000010', N'Review React Component structure and state management workflow.', 'ACCEPTED', 'https://meet.google.com/xyz-uvwx-yza', N'Prepare code repository link before meeting.', '2026-03-09 10:00:00');

    INSERT INTO MentoringFeedbacks (FeedbackId, BookingId, TeamId, MentorUserId, HealthStatus, Content, CreatedAt) VALUES
    ('40000000-0000-0000-0000-000000000001', '90000000-0000-0000-0000-000000000001', '70000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000009', 'Green', N'The team is progressing very well. They understood the quantization techniques and successfully integrated the model API.', '2026-03-10 10:15:00');
