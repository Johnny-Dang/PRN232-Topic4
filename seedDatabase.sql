...
-- 
-- Structure:
-- - 6 Events (Spring 2026, Summer 2026, Fall 2026, Winter 2026, Spring 2025, Hackathon 2026)
-- - 3 Teams (Phoenix AI, Beta Coders, Delta Devs) - each joins 2 events
-- - 3 Mentors (Tony AI, Hannah Web, David Mobile) - each mentors 2 events
-- =========================================================
USE SEAL_Hackathon;
GO
...
BEGIN TRY
    ...
    ('00000000-0000-0000-0000-000000000020','leader.delta@fpt.edu.vn','$2a$12$AWgb9KdKy9sz7BM4KUxXxuH0tPdjFNp.ccFtpnmgB.Zfjv8zXaufm',N'Michael Vu','0901000020','TM0020','TeamLeader','Active',GETDATE()),
    ...
    ('00000000-0000-0000-0000-000000000021','member.delta1@fpt.edu.vn','$2a$12$AWgb9KdKy9sz7BM4KUxXxuH0tPdjFNp.ccFtpnmgB.Zfjv8zXaufm',N'Olivia Tran','0901000021','TM0021','TeamMember','Active',GETDATE()),
    ('00000000-0000-0000-0000-000000000022','member.delta2@uit.edu.vn','$2a$12$AWgb9KdKy9sz7BM4KUxXxuH0tPdjFNp.ccFtpnmgB.Zfjv8zXaufm',N'Ethan Hoang','0901000022','TM0022','TeamMember','Active',GETDATE()),
    ('00000000-0000-0000-0000-000000000023','member.delta3@hcmus.edu.vn','$2a$12$AWgb9KdKy9sz7BM4KUxXxuH0tPdjFNp.ccFtpnmgB.Zfjv8zXaufm',N'Sophia Phan','0901000023','TM0023','TeamMember','Active',GETDATE()),
    ...
    ('00000000-0000-0000-0000-000000000024','mentor.mobile@fpt.edu.vn','$2a$12$AWgb9KdKy9sz7BM4KUxXxuH0tPdjFNp.ccFtpnmgB.Zfjv8zXaufm',N'David Lee','0901000024','ME0003','Mentor','Active',GETDATE()),
    ...
    -- =========================================================
    -- 2. EVENTS (6 Events) - All starting from 24/07/2026
    -- =========================================================
    ...
    -- Event 5: SEAL Spring 2025 (Delta Devs joins, David mentor - historical)
    (
        'E0000000-0000-0000-0000-000000000005',
        'SEAL Spring 2025',
        'Spring',
        2025,
        N'Software Engineering Agile League Spring 2025 for Mobile and Web applications.',
        '2025-03-01',
        '2025-04-30',
        'Completed',
        1,
    ...
    -- Spring 2026 (3 rounds) - All starting from 24/07/2026
    ('A0000000-0000-0000-0000-000000000001','E0000000-0000-0000-0000-000000000001','Preliminary Round',1,'2026-07-26','2026-07-24','2026-07-26'),
    ('A0000000-0000-0000-0000-000000000002','E0000000-0000-0000-0000-000000000001','Semi Final Round',2,'2026-07-29','2026-07-27','2026-07-29'),
    ('A0000000-0000-0000-0000-000000000003','E0000000-0000-0000-0000-000000000001','Final Round',3,'2026-08-01','2026-07-30','2026-08-01'),
    -- Summer 2026 (2 rounds)
    ('A0000000-0000-0000-0000-000000000004','E0000000-0000-0000-0000-000000000002','Preliminary Round',1,'2026-07-26','2026-07-24','2026-07-26'),
    ('A0000000-0000-0000-0000-000000000005','E0000000-0000-0000-0000-000000000002','Final Round',2,'2026-07-29','2026-07-27','2026-07-29'),
    -- Fall 2026 (2 rounds)
    ('A0000000-0000-0000-0000-000000000006','E0000000-0000-0000-0000-000000000003','Preliminary Round',1,'2026-07-26','2026-07-24','2026-07-26'),
    ('A0000000-0000-0000-0000-000000000007','E0000000-0000-0000-0000-000000000003','Final Round',2,'2026-07-29','2026-07-27','2026-07-29'),
    -- Winter 2026 (2 rounds)
    ('A0000000-0000-0000-0000-000000000008','E0000000-0000-0000-0000-000000000004','Preliminary Round',1,'2026-07-26','2026-07-24','2026-07-26'),
    ('A0000000-0000-0000-0000-000000000009','E0000000-0000-0000-0000-000000000004','Final Round',2,'2026-07-29','2026-07-27','2026-07-29'),
    -- Spring 2025 (3 rounds - historical - keep original dates)
    ('A0000000-0000-0000-0000-000000000010','E0000000-0000-0000-0000-000000000005','Preliminary Round',1,'2025-03-20','2025-03-01','2025-03-25'),
    ('A0000000-0000-0000-0000-000000000011','E0000000-0000-0000-0000-000000000005','Semi Final Round',2,'2025-04-05','2025-03-28','2025-04-07'),
    ('A0000000-0000-0000-0000-000000000012','E0000000-0000-0000-0000-000000000005','Final Round',3,'2025-04-20','2025-04-15','2025-04-25'),
    -- Hackathon 2026 (1 round)
    ('A0000000-0000-0000-0000-000000000013','E0000000-0000-0000-0000-000000000006','Final Round',1,'2026-07-26','2026-07-24','2026-07-26');
    ...
    -- Delta Devs: Spring 2025 (Mobile) + Hackathon 2026 (Innovation) -> David Lee
    -- =========================================================
    ...
    -- David Lee (Mobile Mentor) - mentors Mobile in Spring 2025 and Innovation in Hackathon 2026
    ...
    -- =========================================================
    -- 3. TEAMS AND MEMBERS
    -- Phoenix AI -> Spring 2026 (AI Solution) + Winter 2026 (Cloud Solution)
    -- Beta Coders -> Summer 2026 (Blockchain) + Fall 2026 (IoT)
    -- Delta Devs -> Spring 2025 (Mobile) + Hackathon 2026 (Innovation)
    -- =========================================================
    ...
    -- Delta Devs participates in Spring 2025 (Mobile)
    ...
    -- Phoenix AI members
    -- Phoenix AI members (joined before event starts)
    ('91111111-1111-1111-1111-111111111101','70000000-0000-0000-0000-000000000001','00000000-0000-0000-0000-000000000001','2026-07-20'),
    ('91111111-1111-1111-1111-111111111102','70000000-0000-0000-0000-000000000001','00000000-0000-0000-0000-000000000002','2026-07-20'),
    ('91111111-1111-1111-1111-111111111103','70000000-0000-0000-0000-000000000001','00000000-0000-0000-0000-000000000003','2026-07-21'),
    ('91111111-1111-1111-1111-111111111104','70000000-0000-0000-0000-000000000001','00000000-0000-0000-0000-000000000004','2026-07-22'),
    -- Beta Coders members (joined before event starts)
    ('91111111-1111-1111-1111-111111111105','70000000-0000-0000-0000-000000000002','00000000-0000-0000-0000-000000000005','2026-07-20'),
    ('91111111-1111-1111-1111-111111111106','70000000-0000-0000-0000-000000000002','00000000-0000-0000-0000-000000000006','2026-07-20'),
    ('91111111-1111-1111-1111-111111111107','70000000-0000-0000-0000-000000000002','00000000-0000-0000-0000-000000000007','2026-07-21'),
    ('91111111-1111-1111-1111-111111111108','70000000-0000-0000-0000-000000000002','00000000-0000-0000-0000-000000000008','2026-07-22'),
    -- Delta Devs members
    ('91111111-1111-1111-1111-111111111120','70000000-0000-0000-0000-000000000003','00000000-0000-0000-0000-000000000020','2025-02-01'),
    ('91111111-1111-1111-1111-111111111121','70000000-0000-0000-0000-000000000003','00000000-0000-0000-0000-000000000021','2025-02-01'),
    ('91111111-1111-1111-1111-111111111122','70000000-0000-0000-0000-000000000003','00000000-0000-0000-0000-000000000022','2025-02-02'),
    ('91111111-1111-1111-1111-111111111123','70000000-0000-0000-0000-000000000003','00000000-0000-0000-0000-000000000023','2025-02-03');

    INSERT INTO EventParticipants (EventParticipantId, EventID, UserId, RegisteredAt, Status) VALUES
    -- Phoenix AI team in Spring 2026
    ('A1111111-1111-1111-1111-111111111101','E0000000-0000-0000-0000-000000000001','00000000-0000-0000-0000-000000000001','2026-07-20','Registered'),
    ('A1111111-1111-1111-1111-111111111102','E0000000-0000-0000-0000-000000000001','00000000-0000-0000-0000-000000000002','2026-07-20','Registered'),
    ('A1111111-1111-1111-1111-111111111103','E0000000-0000-0000-0000-000000000001','00000000-0000-0000-0000-000000000003','2026-07-21','Registered'),
    ('A1111111-1111-1111-1111-111111111104','E0000000-0000-0000-0000-000000000001','00000000-0000-0000-0000-000000000004','2026-07-22','Registered'),
    -- Beta Coders team in Summer 2026
    ('A1111111-1111-1111-1111-111111111105','E0000000-0000-0000-0000-000000000002','00000000-0000-0000-0000-000000000005','2026-07-20','Registered'),
    ('A1111111-1111-1111-1111-111111111106','E0000000-0000-0000-0000-000000000002','00000000-0000-0000-0000-000000000006','2026-07-20','Registered'),
    ('A1111111-1111-1111-1111-111111111107','E0000000-0000-0000-0000-000000000002','00000000-0000-0000-0000-000000000007','2026-07-21','Registered'),
    ('A1111111-1111-1111-1111-111111111108','E0000000-0000-0000-0000-000000000002','00000000-0000-0000-0000-000000000008','2026-07-22','Registered'),
    -- Delta Devs team in Spring 2025
    ('A1111111-1111-1111-1111-111111111120','E0000000-0000-0000-0000-000000000005','00000000-0000-0000-0000-000000000020','2025-02-01','Registered'),
    ('A1111111-1111-1111-1111-111111111121','E0000000-0000-0000-0000-000000000005','00000000-0000-0000-0000-000000000021','2025-02-01','Registered'),
    ('A1111111-1111-1111-1111-111111111122','E0000000-0000-0000-0000-000000000005','00000000-0000-0000-0000-000000000022','2025-02-02','Registered'),
    ('A1111111-1111-1111-1111-111111111123','E0000000-0000-0000-0000-000000000005','00000000-0000-0000-0000-000000000023','2025-02-03','Registered');

    INSERT INTO RefreshTokens (RefreshTokenId, Token, UserId, ExpiresAt, CreatedAt, RevokedAt) VALUES
    ('F1000000-0000-0000-0000-000000000001', 'seed-refresh-token-leader-phoenix-2026', '00000000-0000-0000-0000-000000000001', '2027-12-31 23:59:59', '2026-01-01 08:00:00', NULL),
    ('F1000000-0000-0000-0000-000000000002', 'seed-refresh-token-coordinator-2026', '00000000-0000-0000-0000-000000000013', '2027-12-31 23:59:59', '2026-01-01 08:00:00', NULL);

    INSERT INTO Notifications (NotificationId, UserId, Message, IsRead, CreatedAt) VALUES
    ('F2000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', N'[NOTIFICATION] Team Phoenix AI đã đăng ký SEAL Spring 2026.', 0, '2026-07-20 09:00:00'),
    ('F2000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000005', N'[NOTIFICATION] Team Beta Coders đã đăng ký SEAL Summer 2026.', 1, '2026-07-20 09:05:00'),
    ('F2000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000020', N'[NOTIFICATION] Team Delta Devs đã đăng ký SEAL Spring 2025.', 1, '2025-02-03 10:00:00');
    ...
    -- No submissions yet - to be submitted during event (24/07/2026 - 01/08/2026)
    ...
    ('D0000000-0000-0000-0000-000000000001', '70000000-0000-0000-0000-000000000001', 'A0000000-0000-0000-0000-000000000001', 'https://github.com/phoenix-ai/project-v1', 'https://youtube.com/phoenix-demo-1', 'https://drive.google.com/phoenix-slide-1', '2026-07-25 14:00:00', 'Submitted', 0, N''),
    ('D0000000-0000-0000-0000-000000000002', '70000000-0000-0000-0000-000000000001', 'A0000000-0000-0000-0000-000000000002', 'https://github.com/phoenix-ai/project-v2', 'https://youtube.com/phoenix-demo-2', 'https://drive.google.com/phoenix-slide-2', '2026-07-28 10:00:00', 'Submitted', 0, N''),
    ('D0000000-0000-0000-0000-000000000003', '70000000-0000-0000-0000-000000000001', 'A0000000-0000-0000-0000-000000000003', 'https://github.com/phoenix-ai/project-final', 'https://youtube.com/phoenix-demo-final', 'https://drive.google.com/phoenix-slide-final', '2026-07-31 09:00:00', 'Submitted', 0, N''),
    -- Submissions for Summer 2026 (Beta Coders)
    ('D0000000-0000-0000-0000-000000000004', '70000000-0000-0000-0000-000000000002', 'A0000000-0000-0000-0000-000000000004', 'https://github.com/beta-coders/blockchain-v1', 'https://youtube.com/beta-demo-1', 'https://drive.google.com/beta-slide-1', '2026-07-25 14:30:00', 'Submitted', 0, N''),
    ('D0000000-0000-0000-0000-000000000005', '70000000-0000-0000-0000-000000000002', 'A0000000-0000-0000-0000-000000000005', 'https://github.com/beta-coders/blockchain-final', 'https://youtube.com/beta-demo-final', 'https://drive.google.com/beta-slide-final', '2026-07-28 11:00:00', 'Submitted', 0, N'');
    ...
    (
        ...
        '2026-07-25 13:45:00', '2026-07-25 13:46:00'
    ),
    (
        ...
        '2026-07-25 14:15:00', '2026-07-25 14:16:00'
    );
    ...
    ('D1111111-1111-1111-1111-000000000001','D0000000-0000-0000-0000-000000000001','AAA00001-0001-0001-0001-000000000001','CC000000-0000-0000-0000-000000000001',9.0, N'Excellent AI innovation', '2026-07-25 15:00:00'),
    ('D1111111-1111-1111-1111-000000000002','D0000000-0000-0000-0000-000000000001','AAA00001-0001-0001-0001-000000000001','CC000000-0000-0000-0000-000000000002',8.5, N'Good architecture and scalability', '2026-07-25 15:10:00'),
    ('D1111111-1111-1111-1111-000000000003','D0000000-0000-0000-0000-000000000001','AAA00001-0001-0001-0001-000000000001','CC000000-0000-0000-0000-000000000003',8.0, N'Nice interface and user experience', '2026-07-25 15:20:00'),
    ('D1111111-1111-1111-1111-000000000004','D0000000-0000-0000-0000-000000000002','AAA00001-0001-0001-0001-000000000003','CC000000-0000-0000-0000-000000000001',9.2, N'Outstanding AI innovation and improvements', '2026-07-28 11:00:00'),
    ('D1111111-1111-1111-1111-000000000005','D0000000-0000-0000-0000-000000000002','AAA00001-0001-0001-0001-000000000003','CC000000-0000-0000-0000-000000000002',8.8, N'Excellent technical complexity', '2026-07-28 11:10:00'),
    ('D1111111-1111-1111-1111-000000000006','D0000000-0000-0000-0000-000000000002','AAA00001-0001-0001-0001-000000000003','CC000000-0000-0000-0000-000000000003',8.3, N'Very good UI improvements', '2026-07-28 11:20:00'),
    ('D1111111-1111-1111-1111-000000000007','D0000000-0000-0000-0000-000000000003','AAA00001-0001-0001-0001-000000000005','CC000000-0000-0000-0000-000000000001',9.3, N'Outstanding AI innovation - champion level', '2026-07-31 10:00:00'),
    ('D1111111-1111-1111-1111-000000000008','D0000000-0000-0000-0000-000000000003','AAA00001-0001-0001-0001-000000000005','CC000000-0000-0000-0000-000000000002',9.0, N'Excellent technical complexity', '2026-07-31 10:10:00'),
    ('D1111111-1111-1111-1111-000000000009','D0000000-0000-0000-0000-000000000003','AAA00001-0001-0001-0001-000000000005','CC000000-0000-0000-0000-000000000003',8.5, N'Very good UI/UX', '2026-07-31 10:20:00'),
    -- Scores for Beta Coders in Summer 2026
    ('D1111111-1111-1111-1111-000000000010','D0000000-0000-0000-0000-000000000004','AAA00001-0001-0001-0001-000000000007','CC000000-0000-0000-0000-000000000001',8.5, N'Good blockchain innovation', '2026-06-20 10:00:00'),
    ('D1111111-1111-1111-1111-000000000011','D0000000-0000-0000-0000-000000000004','AAA00001-0001-0001-0001-000000000007','CC000000-0000-0000-0000-000000000004',8.2, N'Good technical implementation', '2026-06-20 10:10:00'),
    ('D1111111-1111-1111-1111-000000000012','D0000000-0000-0000-0000-000000000004','AAA00001-0001-0001-0001-000000000007','CC000000-0000-0000-0000-000000000006',7.8, N'Good design', '2026-06-20 10:20:00'),
    ('D1111111-1111-1111-1111-000000000013','D0000000-0000-0000-0000-000000000005','AAA00001-0001-0001-0001-000000000009','CC000000-0000-0000-0000-000000000001',8.8, N'Excellent blockchain innovation', '2026-07-10 09:00:00'),
    ('D1111111-1111-1111-1111-000000000014','D0000000-0000-0000-0000-000000000005','AAA00001-0001-0001-0001-000000000009','CC000000-0000-0000-0000-000000000004',8.7, N'Excellent technical complexity', '2026-07-10 09:10:00'),
    ('D1111111-1111-1111-1111-000000000015','D0000000-0000-0000-0000-000000000005','AAA00001-0001-0001-0001-000000000009','CC000000-0000-0000-0000-000000000006',8.5, N'Good design', '2026-07-10 09:20:00'),
    -- Scores for Delta Devs in Spring 2025 (historical)
    ('D1111111-1111-1111-1111-000000000016','D0000000-0000-0000-0000-000000000006','AAA00001-0001-0001-0001-000000000019','CC000000-0000-0000-0000-000000000001',8.5, N'Good innovation', '2025-03-21 09:00:00'),
    ('D1111111-1111-1111-1111-000000000017','D0000000-0000-0000-0000-000000000006','AAA00001-0001-0001-0001-000000000019','CC000000-0000-0000-0000-000000000002',8.3, N'Good technical implementation', '2025-03-21 09:10:00'),
    ('D1111111-1111-1111-1111-000000000018','D0000000-0000-0000-0000-000000000006','AAA00001-0001-0001-0001-000000000019','CC000000-0000-0000-0000-000000000003',8.0, N'Good UI/UX', '2025-03-21 09:20:00'),
    ('D1111111-1111-1111-1111-000000000019','D0000000-0000-0000-0000-000000000007','AAA00001-0001-0001-0001-000000000021','CC000000-0000-0000-0000-000000000001',8.8, N'Excellent innovation', '2025-04-04 09:00:00'),
    ('D1111111-1111-1111-1111-000000000020','D0000000-0000-0000-0000-000000000007','AAA00001-0001-0001-0001-000000000021','CC000000-0000-0000-0000-000000000002',8.6, N'Good technical implementation', '2025-04-04 09:10:00'),
    ('D1111111-1111-1111-1111-000000000021','D0000000-0000-0000-0000-000000000007','AAA00001-0001-0001-0001-000000000021','CC000000-0000-0000-0000-000000000003',8.5, N'Very good UI', '2025-04-04 09:20:00');
    ...
    ('CAC00001-0001-0001-0001-000000000002','00000000-0000-0000-0000-000000000012','CC000000-0000-0000-0000-000000000001','D0000000-0000-0000-0000-000000000004',8.5, N'Calibration baseline score', '2026-06-20 08:00:00'),
    ('CAC00001-0001-0001-0001-000000000003','00000000-0000-0000-0000-000000000011','CC000000-0000-0000-0000-000000000001','D0000000-0000-0000-0000-000000000006',8.5, N'Calibration baseline score', '2025-03-21 08:00:00');
    ...
    ('AAA00001-0001-0001-0001-000000000003','00000000-0000-0000-0000-000000000014','EVENT_CREATE', NULL, '{"EventName":"SEAL Fall 2026"}', '2026-08-01 08:00:00'),
    ('AAA00001-0001-0001-0001-000000000004','00000000-0000-0000-0000-000000000001','TEAM_CREATE', NULL, '{"TeamName":"Phoenix AI"}', '2026-02-15 09:00:00'),
    ('AAA00001-0001-0001-0001-000000000005','00000000-0000-0000-0000-000000000005','TEAM_CREATE', NULL, '{"TeamName":"Beta Coders"}', '2026-05-01 09:00:00'),
    ('AAA00001-0001-0001-0001-000000000006','00000000-0000-0000-0000-000000000020','TEAM_CREATE', NULL, '{"TeamName":"Delta Devs"}', '2025-02-01 09:00:00');
    ...
    ('A1000000-0000-0000-0000-000000000001', '70000000-0000-0000-0000-000000000001', 'A0000000-0000-0000-0000-000000000001', 'C0000000-0000-0000-0000-000000000003', 1, 25.50, '2026-03-22 08:00:00'),
    ('A1000000-0000-0000-0000-000000000002', '70000000-0000-0000-0000-000000000001', 'A0000000-0000-0000-0000-000000000002', 'C0000000-0000-0000-0000-000000000003', 1, 26.30, '2026-04-05 08:00:00'),
    ('A1000000-0000-0000-0000-000000000003', '70000000-0000-0000-0000-000000000001', 'A0000000-0000-0000-0000-000000000003', 'C0000000-0000-0000-0000-000000000003', 1, 26.80, '2026-04-22 08:00:00'),
    -- Summer 2026 rankings (Beta Coders)
    ('A1000000-0000-0000-0000-000000000004', '70000000-0000-0000-0000-000000000002', 'A0000000-0000-0000-0000-000000000004', 'C0000000-0000-0000-0000-000000000004', 1, 24.50, '2026-06-21 08:00:00'),
    ('A1000000-0000-0000-0000-000000000005', '70000000-0000-0000-0000-000000000002', 'A0000000-0000-0000-0000-000000000005', 'C0000000-0000-0000-0000-000000000004', 1, 26.00, '2026-07-11 08:00:00'),
    -- Spring 2025 rankings (Delta Devs - historical)
    ('A1000000-0000-0000-0000-000000000006', '70000000-0000-0000-0000-000000000003', 'A0000000-0000-0000-0000-000000000010', 'C0000000-0000-0000-0000-000000000010', 1, 24.80, '2025-03-22 08:00:00'),
    ('A1000000-0000-0000-0000-000000000007', '70000000-0000-0000-0000-000000000003', 'A0000000-0000-0000-0000-000000000011', 'C0000000-0000-0000-0000-000000000010', 1, 25.90, '2025-04-05 08:00:00'),
    ('A1000000-0000-0000-0000-000000000008', '70000000-0000-0000-0000-000000000003', 'A0000000-0000-0000-0000-000000000012', 'C0000000-0000-0000-0000-000000000010', 1, 25.90, '2025-04-22 08:00:00');
    ...
    ('E1111111-1111-1111-1111-111111111101', '00000000-0000-0000-0000-000000000001', 'Frontend Developer', 'React/Next.js', 'Advanced', GETDATE()),
    ('E1111111-1111-1111-1111-111111111102', '00000000-0000-0000-0000-000000000001', 'UI/UX Designer', 'Figma', 'Intermediate', GETDATE()),
    ('E1111111-1111-1111-1111-111111111103', '00000000-0000-0000-0000-000000000002', 'Backend Developer', 'ASP.NET Core', 'Advanced', GETDATE()),
    ('E1111111-1111-1111-1111-111111111104', '00000000-0000-0000-0000-000000000005', 'Blockchain Developer', 'Solidity', 'Advanced', GETDATE()),
    ('E1111111-1111-1111-1111-111111111105', '00000000-0000-0000-0000-000000000020', 'Mobile Developer', 'React Native', 'Advanced', GETDATE());

    INSERT INTO TeamRecruitments (RecruitmentId, TeamId, RoleNeeded, Description, Quantity, Status, CreatedAt, UpdatedAt) VALUES
    ('50000000-0000-0000-0000-000000000001', '70000000-0000-0000-0000-000000000001', 'AI Researcher', N'Looking for someone with deep knowledge in LLMs and Prompt Engineering.', 1, 'OPEN', GETDATE(), NULL),
    ('50000000-0000-0000-0000-000000000002', '70000000-0000-0000-0000-000000000002', 'Blockchain Developer', N'We need a developer specialized in Web3 and smart contracts.', 1, 'OPEN', GETDATE(), NULL),
    ('50000000-0000-0000-0000-000000000003', '70000000-0000-0000-0000-000000000003', 'UI Designer', N'Looking for a creative UI designer for our mobile app.', 1, 'OPEN', GETDATE(), NULL);

    INSERT INTO TeamApplications (ApplicationId, RecruitmentId, TeamId, UserId, Message, Status, CreatedAt, UpdatedAt) VALUES
    ('60000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000002', '70000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000004', N'I have strong blockchain skills and would love to join your team!', 'PENDING', GETDATE(), NULL);
    ...
    ('80000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000009', '2026-03-10 09:00:00', '2026-03-10 10:00:00', N'Lab 402', 1),
    ('80000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000009', '2026-03-10 10:30:00', '2026-03-10 11:30:00', N'Lab 402', 0),
    ('80000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000009', '2026-12-10 09:00:00', '2026-12-10 10:00:00', N'Google Meet', 0),
    -- Hannah Nguyen (Web Mentor) schedules
    ('80000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000010', '2026-06-10 14:00:00', '2026-06-10 15:00:00', N'Google Meet', 1),
    ('80000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000010', '2026-06-10 15:30:00', '2026-06-10 16:30:00', N'Google Meet', 0),
    ('80000000-0000-0000-0000-000000000006', '00000000-0000-0000-0000-000000000010', '2026-09-10 14:00:00', '2026-09-10 15:00:00', N'Google Meet', 0),
    -- David Lee (Mobile Mentor) schedules
    ('80000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000024', '2025-03-10 09:00:00', '2025-03-10 10:00:00', N'Lab 301', 1),
    ('80000000-0000-0000-0000-000000000008', '00000000-0000-0000-0000-000000000024', '2025-03-10 10:30:00', '2025-03-10 11:30:00', N'Lab 301', 0),
    ('80000000-0000-0000-0000-000000000009', '00000000-0000-0000-0000-000000000024', '2026-08-15 09:00:00', '2026-08-15 10:00:00', N'Lab 301', 0);
